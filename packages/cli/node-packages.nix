...
let
  sources = {
    ...
    "@stoplight/http-spec-7.1.0" = {
      name = "_at_stoplight_slash_http-spec";
      packageName = "@stoplight/http-spec";
      version = "7.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@stoplight/http-spec/-/http-spec-7.1.0.tgz";
        sha512 = "Z2XqKX2SV8a1rrgSzFqccX2TolfcblT+l4pNvUU+THaLl50tKDoeidwWWZTzYUzqU0+UV97ponvqEbWWN3PaXg==";
      };
    };
    ...
    "@stoplight/json-schema-generator-1.0.2" = {
      name = "_at_stoplight_slash_json-schema-generator";
      packageName = "@stoplight/json-schema-generator";
      version = "1.0.2";
      src = fetchurl {
    ...
    "@stoplight/json-schema-merge-allof-0.7.8" = {
      name = "_at_stoplight_slash_json-schema-merge-allof";
      packageName = "@stoplight/json-schema-merge-allof";
      version = "0.7.8";
      src = fetchurl {
    ...
    "@stoplight/json-schema-ref-parser-9.2.7" = {
      name = "_at_stoplight_slash_json-schema-ref-parser";
      packageName = "@stoplight/json-schema-ref-parser";
      version = "9.2.7";
      src = fetchurl {
    ...
    "@stoplight/json-schema-sampler-0.3.0" = {
      name = "_at_stoplight_slash_json-schema-sampler";
      packageName = "@stoplight/json-schema-sampler";
      version = "0.3.0";
      src = fetchurl {
    ...
    "@stoplight/prism-core-5.8.0" = {
      ...
      version = "5.8.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@stoplight/prism-core/-/prism-core-5.8.0.tgz";
        sha512 = "fmH7n6e0thzOGcD5uZBu/Xx1iFNfpc9ACTxPie+lFD54SJ214M2FIFXD7kV+NCFlC+w5OFw+lJRaYM859uMnAg==";
      };
    };
    "@stoplight/prism-http-5.10.0" = {
      name = "_at_stoplight_slash_prism-http";
      packageName = "@stoplight/prism-http";
      version = "5.10.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@stoplight/prism-http/-/prism-http-5.10.0.tgz";
        sha512 = "OlWSv9XobxkNu4D1xfDfwjMSETrw4wNFkWcbKzQmepNERqJ6uuWDDjkIR2f1F7SYU61ElwhaXf1bA9dlze6U6g==";
      };
    };
    "@stoplight/prism-http-server-5.10.0" = {
      name = "_at_stoplight_slash_prism-http-server";
      packageName = "@stoplight/prism-http-server";
      version = "5.10.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@stoplight/prism-http-server/-/prism-http-server-5.10.0.tgz";
        sha512 = "7sdMNzBY4+/96fLQn7/LR6ItDfNwcvCY9XCWrpruWeq5fHJHrb5OynpHvZs9vHcTpZNITBs/sgmukXn35wB5Sw==";
      };
    };
    ...
    "io-ts-2.2.21" = {
      ...
      version = "2.2.21";
      src = fetchurl {
        url = "https://registry.npmjs.org/io-ts/-/io-ts-2.2.21.tgz";
        sha512 = "zz2Z69v9ZIC3mMLYWIeoUcwWD6f+O7yP92FMVVaXEOSZH1jnVBmET/urd/uoarD1WGBY4rCj8TAyMPzsGNzMFQ==";
      };
    };
    "is-arrayish-0.2.1" = {
      name = "is-arrayish";
    ...
    "parse-prefer-header-1.0.0" = {
      ...
      packageName = "parse-prefer-header";
      version = "1.0.0";
      src = fetchurl {
    ...
    "postman-collection-4.5.0" = {
      ...
      version = "4.5.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/postman-collection/-/postman-collection-4.5.0.tgz";
  ...
  args = {
    name = "_at_stoplight_slash_prism-cli";
    packageName = "@stoplight/prism-cli";
    version = "5.10.0";
    src = ./.;
    dependencies = [
      sources."@faker-js/faker-6.3.1"
      sources."@jsdevtools/ono-7.1.3"
      (sources."@stoplight/http-spec-7.1.0" // {
        dependencies = [
          sources."@stoplight/types-14.1.0"
      ...
      sources."@stoplight/json-schema-generator-1.0.2"
      sources."@stoplight/json-schema-merge-allof-0.7.8"
      sources."@stoplight/json-schema-ref-parser-9.2.7"
      sources."@stoplight/json-schema-sampler-0.3.0"
      sources."@stoplight/ordered-object-literal-1.0.5"
      sources."@stoplight/path-1.3.2"
      sources."@stoplight/prism-core-5.8.0"
      sources."@stoplight/prism-http-5.10.0"
      sources."@stoplight/prism-http-server-5.10.0"
      ...
      sources."json-promise-1.1.8"
      sources."json-schema-compare-0.2.2"
      sources."json-schema-faker-0.5.6"
      ...
      sources."parse-prefer-header-1.0.0"
      ...
      sources."uri-template-lite-22.9.0"
